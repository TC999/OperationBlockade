...
_DWORD* __thiscall sub_409AD0(int* self, int a2, unsigned int a3);
...
_DWORD* __thiscall ResetGameParams(_BYTE* self, _DWORD* a2);
...
char __thiscall WriteProfileString(LPVOID* self, const char* a2);
...
int __thiscall SetGameObjectStateFields(_DWORD* self, int a2, int a3, int a4, int a5);
void __thiscall sub_421460(int self, int a2);
int __thiscall UpdateGameObjectLinkedResource(_DWORD* self);
...
_DWORD* __thiscall sub_421980(int self, int a2, unsigned int a3);
...
int __thiscall sub_4226E0(_DWORD* self, int a2);
int __thiscall sub_422740(_DWORD* self, int a2);
int __thiscall AccumulateStats(_DWORD* self, _DWORD* a2, _DWORD* a3, _DWORD* a4, _DWORD* a5);
...
const void* __thiscall UpdateGameHistory(_DWORD* self, int a2);
double __thiscall GetMaxValue(_DWORD* self);
double __thiscall CalcAverageValue(int* self);
void* sub_4231A0();
...
int __thiscall PresentFrame(void* self);
int sub_427EA0();
...
char __thiscall sub_43B2F0(_DWORD* self, int a2, int a3, LPVOID* a4, int a5);
...
char __thiscall sub_43C3A0(_DWORD* self, int a2, int a3, LPVOID* a4, int a5);
...
char __thiscall sub_43CAC0(_DWORD* self, int a2, int a3, LPVOID* a4, int a5);
...
int __thiscall sub_4436D0(_DWORD* self, int a2);
...
BOOL sub_450BC0();
int __thiscall SetGameObjectStateFloat(_DWORD* self, int a2, int a3);
...
int __thiscall sub_47264E(int* a1, _DWORD* a3, unsigned int a4);
